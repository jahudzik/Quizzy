...
public class QuestionTest {
    ...
    public void equals_test1() {
        Question question = new Question("question", "answer", "category");
    ...
    public void equals_test4() {
        Question question1 = new Question("question", "answer", "category");
        Question question2 = new Question("question", "answer", "category");
        assertTrue(question1.equals(question2));
    }

    @Test
    public void equals_test5() {
        Question question1 = new Question("question1", "answer", "category");
        Question question2 = new Question("question2", "answer", "category");
        assertFalse(question1.equals(question2));
    }

    @Test
    public void equals_test6() {
        Question question1 = new Question("question1", null, "category");
        Question question2 = new Question("question2", "answer", "category");
        assertFalse(question1.equals(question2));
    }
    ...
    public void hashCode_test2() {
        Question question1 = new Question("question", "answer", "category1");
        Question question2 = new Question("question", "answer", "category2");
